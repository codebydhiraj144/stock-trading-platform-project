...
function Footer(){
    return (
        <div className='container border-top mt-5' style={{backgroundColor:"rgb(240,240,240)"}}>
            ...
            <div className='col'>
                <img src='stock tradingpic/logo.svg' style={{width:"50%"}}/>
...
All rights reserved.</p>
            ...
            <div className='col '>
              ...
              <a href=''>press cares(CSR)</a> <br></br>
            </div>
            <div className='col'>
                <p>Support</p>
...
<a href="">Contact</a><br />
<a href="">Support portals</a><br />
<a href="">Z-Connect portal</a><br />
